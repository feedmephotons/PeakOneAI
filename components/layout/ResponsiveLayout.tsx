      ...
      >
        <div className="flex items-center justify-between h-full px-4 lg:px-6">
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            ...
            <Link
              href="/settings"
              className="hidden sm:flex items-center space-x-2 p-1.5 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-800 transition-colors"
              title="Settings - Change navigation style"
            >
